...
Welcome to the **Oasis Infobyte Internship (OIBSIP)** portfolio repository by **Komala Nandini** ([@nandini-k-19](https://github.com/nandini-k-19)). This monorepo houses full-stack web applications and Python software engineering projects developed during the internship.
...
## 🍕 Flagship Project: Web Development — Level 3 Task 1
...
- **Key Highlights**:
  ...
  - **Dual Action Menu Cards**: **"Add to Cart"** and instant **"⚡ Buy Now"** express checkout on every card.
  ...
  - **Distinct Order Management & GPS Tracking**:
    - **Orders Ledger (`/orders`)**: Dedicated account ledger with total spend stats, filter tabs (*All*, *Active*, *Delivered*, *Cancelled*), receipt details, and 1-click reorder.
